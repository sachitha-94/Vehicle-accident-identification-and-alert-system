<%-- 
    Document   : V_Remove_Vehicle.jsp
    Created on : Apr 24, 2017, 12:01:55 PM
    Author     : Shaii99
--%>
        ...
        <form class="form-horizontal">
            ...
            <div class="form-group"> 
                <div class="col-sm-offset-2 col-sm-10">
                    <button type="submit" class="btn btn-default">Remove Vehicle</button>
                </div>
            </div>
