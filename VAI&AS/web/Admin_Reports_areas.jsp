<%-- 
    Document   : Admin_Reports_areas
    Created on : Jul 19, 2017, 11:34:39 AM
    Author     : Shaii99
--%>
                ...
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        <li class="text-center">
                            <img src="assets/img/location.png" class="user-image img-responsive"/>
                        </li>
                        ...
                        <li>
                            <a class="active-menu" href="Admin_Reports_areas.jsp"><i class="fa fa-qrcode fa-3x"></i> Areas</a>
                        </li>
                        <li  >
